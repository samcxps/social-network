...
public class SocialNetwork implements SocialNetworkADT {
	 ...
	 *
	 * If the friendship exists in the network, no friendship is added and no
	 * exception is thrown.
	 * 
	 ...
	 * 
	 * If either person does not exist, or if a friendship from user1 to user2 does
	 * not exist, no friendship is removed and UserNotFoundException is thrown
	 * 
	 * @param user1 the first user
	 * @param user2 the second user
	 * 
