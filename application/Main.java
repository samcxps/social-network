...
//        return main;
    ...
    private void createFriendsListWindow() {
        ...
        userHBox.getChildren().addAll(usernameTextField, addUserButton, removeUserButton,
            focusUserButton);
        //////////////////////////////////////////////////////////
        ...
        addFriendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                ...
                if (user1TextField.getText().matches("^[a-zA-Z0-9_']*$")
                    ...
                    && !user1TextField.getText().isEmpty() && !user2TextField.getText().isEmpty()) {
                    try {
                    ...
                    alert.setContentText(
                        "Username can only contain letters, digits, underscores, and apostrophes!");
                    alert.showAndWait();
                }
                mainStage.close();
                createFriendsListWindow();
        ...
        removeFriendButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                ...
                if (user1TextField.getText().matches("^[a-zA-Z0-9_']*$")
                    ...
                    && !user1TextField.getText().isEmpty() && !user2TextField.getText().isEmpty()) {
                    try {
                        socialNetwork.removeFriend(user1TextField.getText(),
                            user2TextField.getText());
                    } catch (UserNotFoundException e) {
                        Alert alert = new Alert(AlertType.ERROR);
                        alert.setTitle("Error");
                        alert.setHeaderText("Username Error");
        ...
        // Add all buttons to HBox
        friendshipHBox.getChildren().addAll(user1TextField, user2TextField, addFriendButton,
            removeFriendButton);
        //////////////////////////////////////////////////////////
     ...
     * 
     * Made this into a separate method to clean up code and avoid reusing the same code for every
     * new button
     * 
